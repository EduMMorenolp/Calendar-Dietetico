// Archivo: src/components/CalendarTable.tsx
            ...
            <div className="bg-white rounded-2xl shadow-2xl overflow-hidden border border-gray-100">
                <div className="grid grid-cols-8 bg-gradient-to-r from-indigo-500 to-purple-600">
                    ...
                    {days.map((day, index) => (
                        <div
                            key={day}
                            className={`p-4 text-center border-r border-indigo-400 last:border-r-0 ${index === 5 || index === 6 ? "bg-indigo-600" : ""
                                }`}
                        >
                    ...
                    >
                        ...
                        {days.map((_, dayIndex) => {
                            ...
                            return (
                                <div
                                    key={dayIndex}
                                    className={`relative p-3 border-r border-gray-200 last:border-r-0 min-h-[180px] transition-all duration-200 ${cell.complete
                                ...
                                >
                                    ...
                                    <textarea
                                        ...
                                        value={cell.text}
                                        onChange={(e) => handleTextChange(catIndex, dayIndex, e.target.value)}
